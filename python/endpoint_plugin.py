...
a = service.createObjectInstance("api1", endpoint_template.guid, {"host": "http://my_host1", "path": "/api/v1/farm1"})
v = service.createObjectInstance("api2", endpoint_template.guid, {"host": "http://my_host1", "path": "/api/v2/farm2"})
s = service.createObjectInstance("api3", endpoint_template.guid, {"host": "http://my_host2", "path": "/api/farm3"})

endpoints = service.instanceOfType("Endpoint")
for instance in endpoints:
    print(instance)